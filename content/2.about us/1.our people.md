...
::
::KPerson
Tom is an experienced full-stack developer who has managed the delivery of operational Semantic Web / Knowledge Graph applications for many years.

He holds a PhD in Computer Science Engineering from Ghent University and his research involvement includes working on the Semantic Web, Linked Data and provenance. He participated in the W3C's Provenance Working Group, contributing to the PROV standard and has built many PROV-based applications.

In addition to his stellar technical skills, Tom brings international government Linked Data experience to KurrawongAI.

#name
Tom de Nies

#position
_Full-stack Semantic Web developer_

#img
![Tom's profile picture](/img/tom.png){width="220"}
::

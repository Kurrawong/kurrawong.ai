...
Organisations typically manage dozens of reference datasets — product classifications, status codes, geographic hierarchies, industry standards — siloed in spreadsheets, duplicated across systems, and updated without governance or traceability. The result is significant additional work, e.g. data integration, inconsistent reporting, and an inability to share reference data confidently across business units.  
...
- **Domain models** - simple to complex ontologies, defining classes, properties and their relations. The next step up from collections of vocabularies
- **Spatial data** - used to locate other data. Can be spatially linked and used for map-based data selection
- **Validators** - it uses validators to validate all the things it edits and it can maintain the validators themselves

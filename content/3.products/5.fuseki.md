...
It is an [RDF](https://en.wikipedia.org/wiki/Resource_Description_Framework) database which implements the [SPARQL Protocol](https://www.w3.org/TR/sparql11-protocol/) so it can be used to expose Knowledge Graph information to applications.

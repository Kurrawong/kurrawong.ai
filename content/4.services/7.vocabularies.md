...
For many projects we create vocabularies for clients, publish them via systems and then train the client to create, govern and publish them, themselves.
...
We then created an extension of the [VocPub](https://linked.data.gov.au/def/vocpub) vocabulary data model to publish these vocabularies with extended derivation and governance information.

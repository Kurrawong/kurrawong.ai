...
Oli<span class="rtl">s</span> does things to ensure you are completely in control of your data and not locked in by it:
...
<br/>
<div style="border-width:3px; border-style:solid; border-color:#000000; padding: 1em;">

...
>
  ...
  <h3>Case Study</h3>
  <h4>Prez for the Geological Survey of Queensland (GSQ)</h4>
  <p>
  ...
  <p>
    ...
    <a href="http://linked.data.gov.au/def/sample-preparation-methods">Sample Preparation Methods.</a>
  </p>
  <p>
    Finding Prez easy to use, GSQ then characterised some of their administrative vocabularies, such
    as
    <a href="https://vocabs.gsq.digital/object?uri=http://linked.data.gov.au/def/transaction-status">Transaction Status</a>
    and presented them via Prez too.
  </p>
  <p>
...
<br/>_for example: on-prem or in the cloud (Azure, AWS, OpenStack)_
...
<br/>_for example: Excel files into vocabularies, File GeoDatabases into spatial Knowledge Graph data_
- **operations**
